...
const AdminAcademy = () => {
  const [academies, setAcademies] = useState([
    { id: 1, name: 'Hikaru Chess Academy', location: 'Japan', image: chessAcademyImage1, rating: 4 },
    { id: 2, name: 'Magnus Chess Academy', location: 'City B', image: chessAcademyImage2, rating: 3 },
    { id: 3, name: 'Pragg Chess Academy C', location: 'City C', image: chessAcademyImage3, rating: 5 },
    { id: 4, name: 'Gotham Chess Academy D', location: 'City D', image: chessAcademyImage4, rating: 2 },
    { id: 5, name: 'Anish Chess Academy E', location: 'City E', image: chessAcademyImage6, rating: 4 },
    { id: 6, name: 'Ding Chess Academy F', location: 'City F', image: chessAcademyImage7, rating: 3 },
